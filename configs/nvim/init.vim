...
vnoremap FF <cmd>W<cr>
nnoremap FF <cmd>W<cr>

" opne a new tab
vnoremap tn <cmd>tabnew<cr>
nnoremap tn <cmd>tabnew<cr>
" close a tab
vnoremap tc <cmd>w <bar> bd<cr>
nnoremap tc <cmd>w <bar> bd<cr>
" move to next tab
vnoremap th <cmd>tabnext<cr>
nnoremap th <cmd>tabnext<cr>
" move to previous tab
vnoremap tl <cmd>tabnext<cr>
nnoremap tl <cmd>tabnext<cr>
" move to the first tab
vnoremap tf <cmd>tabfirst<cr>
nnoremap tf <cmd>tabfirst<cr>
